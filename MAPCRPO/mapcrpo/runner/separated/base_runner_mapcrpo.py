...
from mapcrpo.utils.separated_buffer import SeparatedReplayBuffer
from mapcrpo.utils.util import update_linear_schedule
...
class Runner(object):
    def __init__(self, config):
        ...
        from mapcrpo.algorithms.pcrpo import PCRPO as TrainAlgo

        from mapcrpo.algorithms.r_mappo.algorithm.MACPPOPolicy import MACPPOPolicy as Policy
    ...
    def train(self, aver_episode_costs):
        ...
        for agent_id in torch.randperm(self.num_agents):
            ...
            available_actions = None if self.buffer[agent_id].available_actions is None \
                                                                               ...
                                                                               2:])
            if self.all_args.algorithm_name == "mapcrpo":

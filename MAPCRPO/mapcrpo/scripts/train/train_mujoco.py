...
import torch
from mapcrpo.config import get_config
from mapcrpo.envs.safety_ma_mujoco.safety_multiagent_mujoco import MujocoMulti
from mapcrpo.envs.env_wrappers import ShareSubprocVecEnv, ShareDummyVecEnv
...
def main(args):
    ...
    if all_args.algorithm_name == "mapcrpo":
    ...
    if all_args.share_policy:
        from mapcrpo.runner.shared.mujoco_runner import MujocoRunner as Runner
    else:
        #in origin code not implement this method
        if all_args.algorithm_name == "mapcrpo":
            from mapcrpo.runner.separated.mujoco_runner_mapcrpo import MujocoRunner as Runner
        else:
            from mapcrpo.runner.separated.mujoco_runner import MujocoRunner as Runner

...
def get_config():
    ...
    parser = argparse.ArgumentParser(
        description='mappo_pcrpo', formatter_class=argparse.RawDescriptionHelpFormatter)

    # prepare parameters
    parser.add_argument("--algorithm_name", type=str,
                        default=' ', choices=[ "mappo_pcrpo"])
    ...
    # todo: lagrangian_coef is the lagrangian coefficient for mappo_pcrpo

...
import torch
from mappo_pcrpo.config import get_config
from mappo_pcrpo.envs.safety_ma_mujoco.safety_multiagent_mujoco import MujocoMulti
from mappo_pcrpo.envs.env_wrappers import ShareSubprocVecEnv, ShareDummyVecEnv
...
def main(args):
    ...
    if all_args.algorithm_name == "mappo_pcrpo":
    ...
    if all_args.share_policy:
        from mappo_pcrpo.runner.shared.mujoco_runner import MujocoRunner as Runner
    else:
        #in origin code not implement this method
        if all_args.algorithm_name == "mappo_pcrpo":
            from mappo_pcrpo.runner.separated.mujoco_runner_mappo_pcrpo import MujocoRunner as Runner
        else:
            from mappo_pcrpo.runner.separated.mujoco_runner import MujocoRunner as Runner
